  ...
  <div class="flex-1 px-8 py-8 min-h-screen bg-gray-50 font-sans">
    ...
    <div class="mb-8 fade-up delay-1">
      ...
      <div class="flex items-start justify-between gap-4">
        ...
        <button
          @click="$router.back()"
          class="flex-shrink-0 flex items-center gap-2 px-4 py-2 border border-gray-200 rounded-xl text-sm text-gray-600 hover:border-black hover:text-black transition-all duration-200 font-medium"
        >
          <svg
            class="w-4 h-4"
            fill="none"
    ...
    <!-- ═══════════════════ ALERT BANNERS ═══════════════════ -->
    <div class="space-y-2 mb-6 fade-up delay-1">
      <div
    ...
    <div class="grid grid-cols-1 xl:grid-cols-3 gap-6">
        ...
        >
          ...
          <div class="px-6 pb-6">
            <div class="flex items-end justify-between -mt-8 mb-4">
              <div
                class="w-16 h-16 rounded-2xl bg-gray-900 flex items-center justify-center text-white text-2xl font-bold border-4 border-white shadow-sm flex-shrink-0"
              >
                {{ initials(user.name) }}
              </div>
              <span
            ...
            <div class="mt-5 space-y-2.5">
              ...
              >
                <div
                  class="w-7 h-7 bg-gray-100 rounded-lg flex items-center justify-center flex-shrink-0"
                >
                  <svg
      ...
      <div class="xl:col-span-2 space-y-5 fade-up delay-3">
        <!-- Stats grid -->
                  ...
                  >
                    <td class="px-6 py-3.5">
                      <div class="flex items-center gap-3">
                        <div
                          class="w-9 h-9 rounded-xl bg-cover bg-center bg-gray-100 flex-shrink-0"
                          :style="{
          ...
          <div v-if="activeTab === 'login'" class="p-6">
            <div class="space-y-3">
              ...
              >
                <div class="flex items-center gap-3">
                  <div
                    class="w-9 h-9 bg-white rounded-xl border border-gray-100 flex items-center justify-center flex-shrink-0"
                  >
                    <svg
            ...
            <div class="relative">
              ...
              <div class="space-y-5">
                ...
                >
                  <div
                    :class="[
                      'w-8 h-8 rounded-xl flex items-center justify-center flex-shrink-0 z-10 border-2 border-white',
