...
return [
    ...
    'auth' => [
        ...
        'extra_info' => 'Dapatkan token Anda dengan melakukan login atau register, lalu gunakan header `Authorization: Bearer <token>` untuk mengakses endpoint yang dilindungi.',
    ],
